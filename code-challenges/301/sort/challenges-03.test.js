...
describe('Testing challenge 2', () => {
  test('It should sort strings alphabetically', () => {
    expect(alphabetize(['alphabet', 'Zebra', 'Alphabet', 'carrot'])).toStrictEqual([
      'Alphabet',
      'Zebra',
      'alphabet',
      'carrot',
...
describe('Testing challenge 4', () => {
  test('It should alphabetize without regard to capitalization', () => {
    expect(alphabetizeBetter(['Alice', 'apple', 'alert', 'Average'])).toStrictEqual([
      'alert',
      'Alice',
      'apple',
      'Average',
...
describe('Testing challenge 7', () => {
  test('It should sort people by their last names', () => {
    ...
    expect(sortPeople([{ lastName: 'banana' }, { lastName: 'apple' }])).toStrictEqual([
      { lastName: 'apple' },
      { lastName: 'banana' },
    ]);
  });
...
describe('Testing challenge 8', () => {
  test('It should sort people with more strict ordering', () => {
    ...
    expect(
      sortPeopleBetter([{ firstName: 'andrew', lastName: 'apple' }, { firstName: 'andre', lastName: 'apple' }])
...
describe('Testing challenge 9', () => {
  test('It should sort meetings by the day on which they happen', () => {
    ...
    expect(sortedMeetings.slice(0, 2)).toEqual(
      expect.arrayContaining([new Meeting('Monday', '0900', '0945'), new Meeting('Monday', '0900', '1000')])
    );
    expect(sortedMeetings[2]).toStrictEqual(new Meeting('Tuesday', '1145', '1315'));
    expect(sortedMeetings.slice(3, 5)).toEqual(
      expect.arrayContaining([new Meeting('Wednesday', '0930', '1000'), new Meeting('Wednesday', '1300', '1500')])
    );
